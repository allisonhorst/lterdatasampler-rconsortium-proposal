...
To select the right teaching dataset, we are taking into account several parameters:
- Interesting and relatable topic
- Easy to understand data set
- Can be simplified, while still presenting interesting patterns or relationships

In terms of the package itself, or in other words the combination of the various data sets, we want to:
- Cover a large variety of data science techniques, both in terms of data wrangling and analysis
- Have a mix of various data type (tabular, spatial, text, ...)
- Offer a large variety of topics that are relatable to people

There is thus a lot of trials and errors before finding the right data set and although the current package has 8 data samples, there are a lot more that have already been explored. Nevertheless we are convinced that the LTER network has the data richness for this project and plan to use our connections with this community to find the best teaching data sets.
